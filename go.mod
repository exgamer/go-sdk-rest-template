module github.com/exgamer/go-sdk-rest-template
...
require (
	...
	github.com/exgamer/gosdk-http-core v1.0.13
	github.com/exgamer/gosdk-http-request-builder v1.0.7
	github.com/exgamer/gosdk-postgres-core v1.0.7
